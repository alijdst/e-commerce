...
from mainshop.models import Cart, Order, OrderItem, Payment, Products
...
def callback_gateway_view(request):
    ...
    if bank_record.is_success:
        ...
        # context = {}
        # prod_buy = IsBuy.objects.create(product_id=pk, user=current_user, is_buy=True)
        # prod_buy.save()
        # context['buy_items'] = prod_buy
